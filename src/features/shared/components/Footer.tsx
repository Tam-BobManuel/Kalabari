      ...
      <div className="bg-[#3c3d45] mt-2">
        ...
        <div className="text-white w-11/12 my-0 mx-auto flex flex-col-reverse gap-y-3.5 md:flex-row lg:flex-row items-center justify-between pt-5 pb-2">
          ...
          <div className="flex flex-col items-center gap-y-1.5 md:items-end lg:items-end w-fit">
            <h3 className="font-normal text-sm">CONTACT US</h3>
            <div className="flex items-center gap-x-2.5">
              <a href="https://www.facebook.com/southern.gloryy">
                <img
                ...
                <DialogContent className="bg-black border-gray text-white md:max-w-[50%] sm:max-w-[95%]">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-base text-white text-center">
                      Send us a mail without leaving the app. Click 'send
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-row-4 items-center gap-4">
                      ...
                      >
                        <Label
                          htmlFor="name"
                          className="text-xl mt-4 text-center w-full col-span-3"
                        >
                          Name
                        </Label>
                        <Input
                        ...
                        <Label
                          htmlFor="username"
                          className="text-xl mt-4 text-center col-span-3"
                        >
                          Email
                        </Label>
                        <Input
              ...
              <a href="https://twitter.com/tam_webdev">
                <img src="/icons/X.svg" alt="X" width={35} height={35} />
              </a>
              <a href="https://www.instagram.com/bobmanuel__/">
                <img
